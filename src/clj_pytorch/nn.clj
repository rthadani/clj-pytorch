...
(defmacro defmodule
  ...
  {:pre [(symbol? sym) (vector? params) (some? forward)]}
  `(defn ~sym ~params
...
(defn expand-sequential-output
  "Expand the output size of a Sequential's final Linear layer, copying
   existing weights into the new layer. New neurons initialise randomly."
